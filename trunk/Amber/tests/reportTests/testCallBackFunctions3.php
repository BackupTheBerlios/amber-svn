...
// - and not canceling Report_NoData

class testCallBackFunctions3 extends AmberReport_UserFunctions
...
print $html;
    ...
    $test->assertEquals(1, $this->calls['Detailbereich_Format'], $id . ' Detailbereich_Format');
    $test->assertEquals(1, $this->calls['Detailbereich_Print'], $id . ' Detailbereich_Print');
    ...
    $test->assertEquals(1, $this->calls['Gruppenkopf0_Format'], $id . ' Gruppenkopf0_Format');
    $test->assertEquals(1, $this->calls['Gruppenkopf0_Print'], $id . ' Gruppenkopf0_Print');
    $test->assertEquals(1, $this->calls['Gruppenfuss1_Format'], $id . ' Gruppenfuss1_Format');
    $test->assertEquals(1, $this->calls['Gruppenfuss1_Print'], $id . ' Gruppenfuss1_Print');
    $test->assertEquals(1, $this->calls['Gruppenkopf2_Format'], $id . ' Gruppenkopf2_Format');
    $test->assertEquals(1, $this->calls['Gruppenkopf2_Print'], $id . ' Gruppenkopf2_Print');
    $test->assertEquals(1, $this->calls['Gruppenfuss3_Format'], $id . ' Gruppenfuss3_Format');
    $test->assertEquals(1, $this->calls['Gruppenfuss3_Print'], $id . ' Gruppenfuss3_Print');
  }
