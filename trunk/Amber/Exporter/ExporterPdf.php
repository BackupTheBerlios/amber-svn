...
class ExporterFPdf extends Exporter
{
  ...
  {
    $this->_pdf->SetClipping(0, $y, $w + 2*$this->SectionSlip, $h + 2*$this->SectionSlip);
    $this->_pdf->SetCoordinate(0 + $this->SectionSlip, -($y + $this->SectionSlip));

    $this->_pdf->SetXY(0, 0 + $this->SectionSlip);
    ...
    $align = 'C';
    $backstyle= 1;
    $this->_pdf->Cell($w + $this->SectionSlip, $h, $text, $border, $ln, $align, $fill);
  }
